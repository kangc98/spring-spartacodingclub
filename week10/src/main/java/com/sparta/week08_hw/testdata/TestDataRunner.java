package com.sparta.week08_hw.testdata;

import com.sparta.week08_hw.dto.ItemDto;
...
import com.sparta.week08_hw.repository.UserRepository;
import com.sparta.week08_hw.service.UserService;
import com.sparta.week08_hw.util.NaverShopSearch;
...
public class TestDataRunner implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        // 테스트 User 생성
        User testUser = new User("k", passwordEncoder.encode("k"), "k", UserRole.USER);
