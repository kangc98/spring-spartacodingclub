package com.sparta.week08_hw.aop;

import com.sparta.week08_hw.model.User;
import com.sparta.week08_hw.model.UserTime;
import com.sparta.week08_hw.repository.UserTimeRepository;
...
public class UserTimeAop {
    ...
    @Around("execution(public * com.sparta.week06.controller..*(..))") // 수행될 위치
    public Object execute(ProceedingJoinPoint joinPoint) throws Throwable { // 부가 기능 수행 메서드
        // 측정 시작 시간
